...
public class Start
{
	public static void main(String args[])
	{
		...
		while(repeat)
		{
			...
			System.out.println("\t\t\t\t5. Show Courier Information");
			...
			switch(choice)
			{
				...
				case 4:
					...
					System.out.println("-------------------------------------");
					System.out.println("You have selected Parcel Operation");
					System.out.println("-------------------------------------");
				
					System.out.println("What do you want to do?\n");
					
					System.out.println("\t1. Booking Parcel");
					System.out.println("\t2. Deliver Parcel");
					System.out.println("\t3. Show Parcel History");
					...
					switch(option4)
					{
						case 1:
							...
							Parcel a1 = Courier.searchParcel(an1);
							
							if(a1 != null)
							{
								System.out.println("*** Parcel Verified  ***");
								System.out.println("Parcel sender Name  : " + a1.getCustomer().getSName());
								System.out.println("Parcel receiver Name: " + a1.getCustomer().getRName());
								
								System.out.println("Parcel Charge: " + a1.getCharge());
								
								System.out.print("Booking Quantity : ");
								...
								if(a1.Booking(am))
								{
									...
									System.out.println("Parcel Charge: " + a1.getCharge());
									frwd.writeInFile(am + " Booking in " + a1.getParcelNumber());
								}
								else
								{
							...
							{
								System.out.println("***  Invalid Parcel, Can NOT Booking  ***");
							}
						...
						case 2:
							...
							if(a2 != null)
							{
								...
								System.out.println("Parcel Charge : " + a2.getCharge());
								
								System.out.print("Delivery Quantity : ");
								double am = sc.nextDouble();
								
								if(a2.Receive(am))
								{
									System.out.println("====  Delivery Sucessfull  ====");
									System.out.println("Status: " + a2.getCharge() + " Parcel in stock");
									frwd.writeInFile(am + " Received percel Number " + a2.getParcelNumber());
								}
								else
								{
